...
fun App() {
    Column(
        ...
        Text(
            text = if (isBoxOpen) "Esconder resultado"
            else "Ver resultado",
            fontWeight = FontWeight.Bold,
            color = Color.Black,
            fontSize = 20.sp,
...
private fun calcularIMC(altura: String, peso: String): String {
    val alturaAoQuadrado = (altura.toDouble() / 100).pow(2.0)
    val imc = (peso.toDouble() / alturaAoQuadrado)
